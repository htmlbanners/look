...
(lib.Символ8 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:1},9).wait(470).to({scaleX:1.1,scaleY:1.1,x:134.9,y:105},7,cjs.Ease.get(-1)).to({regX:114.6,regY:37.1,scaleX:1.22,scaleY:1.22,x:158,y:182.6},8,cjs.Ease.get(1)).wait(90).to({alpha:0},15).wait(1));
...
(lib.Символ6 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(345).to({_off:false},0).to({y:0.1,alpha:1},24,cjs.Ease.get(1)).wait(50).to({y:-14.5,alpha:0},25,cjs.Ease.get(-1)).to({_off:true},1).wait(155));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(213).to({_off:false},0).to({y:-15.2,alpha:1},24,cjs.Ease.get(1)).wait(97).to({y:-29.8,alpha:0},25,cjs.Ease.get(-1)).to({_off:true},1).wait(240));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(99).to({_off:false},0).to({y:0.1,alpha:1},24,cjs.Ease.get(1)).wait(78).to({y:-14.5,alpha:0},25,cjs.Ease.get(-1)).to({_off:true},48).wait(326));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3}]}).to({state:[{t:this.instance_3}]},15).to({state:[{t:this.instance_3}]},9).to({state:[{t:this.instance_3}]},50).to({state:[{t:this.instance_4}]},25).to({state:[]},1).wait(500));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({y:9.8,alpha:0.629},15).to({y:4.4,alpha:1},9).wait(50).to({startPosition:0},0).to({_off:true,y:-14.5,alpha:0},25,cjs.Ease.get(-1)).wait(501));

	// Слой 7
	this.instance_5 = new lib.Символ1();
	this.instance_5.setTransform(-0.3,13.1,1,1,0,0,0,192.5,60);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(454).to({y:14.6},0).to({scaleY:2.75,y:-126.4},8,cjs.Ease.get(-1)).to({regY:59.9,scaleY:4.28,y:-247.4},7,cjs.Ease.get(1)).wait(110).to({regY:60,scaleY:1,y:14.6},0).wait(21));
...
(lib.Символ5 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(496).to({_off:false},0).to({scaleX:1.08,scaleY:1.08,y:-226.9,alpha:1},15,cjs.Ease.get(1)).wait(65).to({regY:25.9,scaleX:0.81,scaleY:0.81,alpha:0},10,cjs.Ease.get(-1)).wait(14));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(493).to({_off:false},0).to({alpha:1},15,cjs.Ease.get(1)).wait(70).to({x:199.7,alpha:0},10,cjs.Ease.get(-1)).wait(12));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(490).to({_off:false},0).to({alpha:1},15,cjs.Ease.get(1)).wait(69).to({x:366.2,alpha:0},10,cjs.Ease.get(-1)).wait(16));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(483).to({_off:false},0).to({y:-40.9,alpha:1},15,cjs.Ease.get(1)).wait(78).to({alpha:0},10,cjs.Ease.get(-1)).wait(14));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(479).to({_off:false},0).to({y:-54,alpha:1},15,cjs.Ease.get(1)).wait(84).to({alpha:0},10,cjs.Ease.get(-1)).wait(12));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(475).to({_off:false},0).to({y:-71.9,alpha:1},15,cjs.Ease.get(1)).wait(90).to({alpha:0},10,cjs.Ease.get(-1)).wait(10));

	// Слой 1
	this.instance_6 = new lib.Символ19();
	this.instance_6.setTransform(292,5.5,1,0.133,0,0,0,126,206.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(460).to({regX:126.1,regY:206,scaleY:1.36,x:294.1,y:-249},15,cjs.Ease.get(1)).wait(114).to({scaleX:1.04,scaleY:1.36,x:297.3,y:-247.8},0).to({regY:205.9,scaleX:1,scaleY:0.07,x:298.5,y:-543.7},10,cjs.Ease.get(-1)).wait(1));
...
(lib.Символ3 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:53.5},499).wait(1).to({x:331.5},0).to({x:311.5},99).wait(1));
...
(lib.sept_kvart_300600 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
